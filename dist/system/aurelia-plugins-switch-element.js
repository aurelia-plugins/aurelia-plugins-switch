System.register(['aurelia-dependency-injection', 'aurelia-templating', './aurelia-plugins-switch-utilities'], function (_export, _context) {
  ...
  var inject, bindable, customElement, Utilities;
  return {
    ...
    execute: function () {
      ...
      let Switch = (_dec = customElement('aup-switch'), _dec2 = inject(Element), _dec(_class = _dec2(_class = (_class2 = class Switch {
        constructor(element) {
